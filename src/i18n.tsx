...
const zhCN = {
  ...
  "themes.communityHint": "社区主题免费使用，无需登录",
  ...
  "account.loginReTheme": "登录 ReTheme",
  ...
  "settings.stableChannel": "ReTheme 0.1.0 · 稳定通道",
