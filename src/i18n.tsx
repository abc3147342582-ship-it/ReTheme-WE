...
const zhCN = {
  ...
  "nav.store": "在线商店",
  "nav.main": "主导航",
  "brand.subtitle": "Wallpaper Engine 本地版",
  ...
  "overview.diagnostic": "版本兼容自检",
  "overview.allPassed": "全部通过",
  "overview.incompatible": "兼容自检未通过",
  "overview.diagnosing": "诊断中…",
  "overview.pending": "待运行",
  "overview.diagnosticPassed": "回环限定 · 完整撤销 · {duration} ms",
  "overview.diagnosticMissing": "适配器探针缺失或版本不匹配：{probes}",
  "overview.versionOutOfRange": "ChatGPT 版本超出适配器声明范围",
  "overview.diagnosticDetail": "ChatGPT 版本变化后自动检查适配器与本地注入通道",
  ...
  "wallpaper.title": "Wallpaper Engine 动态壁纸",
  "wallpaper.hint": "扫描本机 Workshop；支持 Video、Scene 和受限沙箱 Web 项目，不受 8MB 图片限制",
  "wallpaper.found": "找到 {count} 个可执行项目：Video {video}、Scene {scene}、Web {web}；{unsupported} 个不可用",
  "wallpaper.select": "选择 Wallpaper Engine 壁纸",
  "wallpaper.groupWithoutEngine": "无需打开 Wallpaper Engine",
  "wallpaper.groupWithoutEngineDetail": "{video} Video · {web} Web",
  "wallpaper.groupWithEngine": "同步 Wallpaper Engine 桌面",
  "wallpaper.groupWithEngineDetail": "{scene} 原生分辨率原版 Scene",
  "wallpaper.selectWithoutEngine": "选择无需打开 Wallpaper Engine 的壁纸",
  "wallpaper.selectWithEngine": "选择与 Wallpaper Engine 桌面同步的壁纸",
  "wallpaper.desktopSyncNotice": "应用后会同步替换主显示器桌面壁纸；ReTheme 使用屏幕外干净捕获窗口",
  "wallpaper.chooseGroup": "选择此分类中的壁纸…",
  "wallpaper.scanning": "扫描中…",
  "wallpaper.empty": "没有找到可执行的 Wallpaper Engine 项目",
  "wallpaper.rescan": "重新扫描",
  "wallpaper.opening": "正在打开…",
  "wallpaper.apply": "应用动态壁纸",
  "wallpaper.brightness": "壁纸亮度",
  "wallpaper.brightnessValue": "{value}%",
  "wallpaper.interfaceTransparency": "界面透明度",
  "wallpaper.interfaceTransparencyValue": "{value}% 透明",
  ...
  "settings.lowMemory": "主题运行后释放管理界面",
  "settings.lowMemoryDetail": "默认开启；关闭 WebView 以节省内存，点击托盘图标可重新打开",
  "settings.update": "更新",
  "settings.autoUpdate": "自动检查更新",
  "settings.autoUpdateDetail": "仅安装通过 ReTheme 签名验证的更新",
  "settings.updateRepository": "GitHub 更新仓库",
  "settings.updateRepositoryDetail": "格式 owner/repo；只安装 ReTheme WE 签名的 Releases",
  "settings.configureUpdateRepository": "请先配置 GitHub 更新仓库（owner/repo）",
...
const en: Messages = {
  ...
  "brand.subtitle": "Wallpaper Engine local build", "brand.backOverview": "Back to ReTheme overview",
  ...
  "wallpaper.title": "Wallpaper Engine live wallpaper", "wallpaper.hint": "Scan the local Workshop; Video, original Scene, and sandboxed Web projects are supported without the 8 MB image limit", "wallpaper.found": "Found {count} runnable projects: {video} Video, {scene} Scene, {web} Web; {unsupported} unavailable", "wallpaper.select": "Choose a Wallpaper Engine wallpaper", "wallpaper.groupWithoutEngine": "Wallpaper Engine not required", "wallpaper.groupWithoutEngineDetail": "{video} Video · {web} Web", "wallpaper.groupWithEngine": "Sync Wallpaper Engine desktop", "wallpaper.groupWithEngineDetail": "{scene} native-resolution original Scene", "wallpaper.selectWithoutEngine": "Choose a wallpaper that does not require Wallpaper Engine", "wallpaper.selectWithEngine": "Choose a wallpaper synchronized with the Wallpaper Engine desktop", "wallpaper.desktopSyncNotice": "Applying also replaces the primary-monitor desktop wallpaper; ReTheme uses a clean off-screen capture window", "wallpaper.chooseGroup": "Choose a wallpaper from this category…", "wallpaper.scanning": "Scanning…", "wallpaper.empty": "No runnable Wallpaper Engine projects found", "wallpaper.rescan": "Rescan", "wallpaper.opening": "Opening…", "wallpaper.apply": "Apply live wallpaper", "wallpaper.brightness": "Wallpaper brightness", "wallpaper.brightnessValue": "{value}%", "wallpaper.interfaceTransparency": "Interface transparency", "wallpaper.interfaceTransparencyValue": "{value}% transparent",
  ...
  "sidebar.connected": "ChatGPT · Connected", "sidebar.detecting": "Detecting ChatGPT…", "sidebar.disconnected": "ChatGPT not connected", "status.localChannel": "Local theme channel", "status.demoData": "Demo data", "status.localPreview": "Local preview", "status.wallpaperEngine": "Live wallpaper", "status.themeRunning": "Theme running", "status.account": "Account {status}",
